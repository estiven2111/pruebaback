...
const createPaymentControler = (req, res) => {
    ...
    const body = {
        ...
        application_context: {
            ...
            return_url: `https://pruebaback-production-0050.up.railway.app/ticket/execute-payment`,
            cancel_url: `https://pruebaback-production-0050.up.railway.app/ticket/cancel-payment` 
        }
    }
